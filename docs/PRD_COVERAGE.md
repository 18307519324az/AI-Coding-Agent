...
| System can create GitHub PR | Unverified | Live mode code exists in `approvePrFlow`, `git-publisher.ts`, and `github-service.ts`; `pnpm smoke:live-pr` harness exists but has not been run against a real test repo in this audit. |
